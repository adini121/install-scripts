...
/usr/bin/expect <<EOD
set timeout 1000
$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py createsuperuser
expect "Username:"
send "admin\r"
expect "Email:"
...
EOD
source $amoInstance/bin/activate
$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py loaddata zadmin/users

sleep 2
echo "________________________Done: initialize_db___________________________"

$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py generate_addons --app firefox 10
$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py generate_addons --app thunderbird 10
$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py generate_addons --app android 10
$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py generate_addons --app seamonkey 10
$amoInstance/bin/python /home/$user/AMOHome/$amoInstance/manage.py generate_themes 10
source $amoInstance/bin/activate
/usr/bin/expect <<EOD
set timeout 500
