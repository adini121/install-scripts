...
fullData <- read.csv('/Users/adityanisal/Dropbox/ExtractedResultFiles/New-CSV/Jenkins-Core-plugins-combined.csv',header=TRUE, sep=",")
# display data
fullData
...
dev.new()
myplot.lars(fit,breaks = FALSE,lty=1,cex.lab=0.9,cex.axis=0.7,ylim = c(-3,6))
# text(fin_x,y)
# labs <- names(x)
