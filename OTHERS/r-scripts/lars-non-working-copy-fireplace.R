...
rawfireplaceData <- read.csv('/Users/adityanisal/Dropbox/ExtractedResultFiles/New-CSV/Fireplace-combined.csv',header=TRUE, sep=",")
# display data
rawfireplaceData
fireplaceData <- rawfireplaceData
fireplaceData
...
fireplace_x_var <- fireplaceDataNonZero[,c(1:8)]
fireplace_x_var
# solution vector
fireplace_y_var <- fireplaceDataNonZero[,9]
fireplace_y_var
...
dev.new()
fireplacemyplot.lars(fireplace_fit,breaks = FALSE,lty=1,cex.lab=0.9,cex.axis=0.7,ylim = c(-0.2,0.2))
